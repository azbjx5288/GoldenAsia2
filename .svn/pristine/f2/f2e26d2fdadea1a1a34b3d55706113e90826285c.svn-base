 ...
 */
public class TableMenuGgc extends ViewGroup implements View.OnClickListener {
    ...
    private OnClickGgcMethodListener onClickGgcMethodListener;

    public interface OnClickGgcMethodListener
    {
        void onClickMethod(Method method);
    }

    public TableMenuGgc(Context context) {
        super(context);
    }

    public TableMenuGgc(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public TableMenuGgc(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnClickGgcMethodListener(OnClickGgcMethodListener onClickGgcMethodListener) {
        this.onClickGgcMethodListener = onClickGgcMethodListener;
    }
    ...
    public void onClick(View v) {
        if (onClickGgcMethodListener != null) {
            onClickGgcMethodListener.onClickMethod(((Method)v.getTag()));
        }
    }
}
