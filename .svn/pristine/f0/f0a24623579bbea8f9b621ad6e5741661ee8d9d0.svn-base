...
public class WithdrawDepositFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflateView(inflater, container, "快速提现", R.layout.fragment_withdraw_deposit);
    }
    ...
    protected void initData() {
        fragments.add(Fragment.instantiate(getActivity(), DrawFragment.class.getName()));
        fragments.add(Fragment.instantiate(getActivity(), WithdrawListFragment.class.getName()));
    }
