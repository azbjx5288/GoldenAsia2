...
public class MmcOneArmBanditView
{
    private static final String TAG = MmcOneArmBanditView.class.getSimpleName();
    ...
    public MmcOneArmBanditView(Context context, View view)
    {
        init(context, view);
    }
