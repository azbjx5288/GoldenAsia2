 ...
 */
@DatabaseTable()
public class MmcKuaiSanWinHistory {
    ...
    public MmcKuaiSanWinHistory() {
    }

    public MmcKuaiSanWinHistory(int uid, String count, String number, String betMoney, String winMoney) {
        this.uid = uid;
        this.count = count;
        this.number = number;
        this.betMoney = betMoney;
