 ...
 */
public class TagCloudViewEdit extends ViewGroup {

    private static final String TAG = TagCloudViewEdit.class.getSimpleName();
    ...
    private static final int SELCECT_TEXT_COLOR = R.color.gameListItemFail;//选中后的标签颜色
    ...
    public TagCloudViewEdit(Context context) {
        this(context, null);
    }

    public TagCloudViewEdit(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TagCloudViewEdit(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTagSize = a.getDimension(R.styleable.TagCloudViewEdit_TCVETextSize, DEFAULT_TEXT_SIZE);
        mTagColor = a.getColor(R.styleable.TagCloudViewEdit_TCVETextColor, DEFAULT_TEXT_COLOR);
        mSeclectTagColor = a.getColor(R.styleable.TagCloudViewEdit_TCVESeclecTextColor, getResources().getColor(SELCECT_TEXT_COLOR));
        mBackground = a.getResourceId(R.styleable.TagCloudViewEdit_TCVEBackground, DEFAULT_TEXT_BACKGROUND);
        mViewBorder = a.getDimensionPixelSize(R.styleable.TagCloudViewEdit_TCVEBorder, DEFAULT_VIEW_BORDER);
        mTagBorderHor = a.getDimensionPixelSize(
                R.styleable.TagCloudViewEdit_TCVEItemBorderHorizontal, DEFAULT_TEXT_BORDER_HORIZONTAL);
        mTagBorderVer = a.getDimensionPixelSize(
                R.styleable.TagCloudViewEdit_TCVEItemBorderVertical, DEFAULT_TEXT_BORDER_VERTICAL);
        mCanTagClick = a.getBoolean(R.styleable.TagCloudViewEdit_TCVECanTagClick, DEFAULT_CAN_TAG_CLICK);

        mRightImageResId = a.getResourceId(R.styleable.TagCloudViewEdit_TCVERightResId, DEFAULT_RIGHT_IMAGE);
        mSingleLine = a.getBoolean(R.styleable.TagCloudViewEdit_TCVESingleLine, DEFAULT_SINGLE_LINE);
        mShowRightImage = a.getBoolean(R.styleable.TagCloudViewEdit_TCVEShowRightImg, DEFAULT_SHOW_RIGHT_IMAGE);
        mShowEndText = a.getBoolean(R.styleable.TagCloudViewEdit_TCVEShowEndText, DEFAULT_SHOW_END_TEXT);
        endTextString = a.getString(R.styleable.TagCloudViewEdit_TCVEEndText);

        mTagResId = a.getResourceId(R.styleable.TagCloudViewEdit_TCVETagResId, DEFAULT_TAG_RESID);
