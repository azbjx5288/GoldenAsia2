...
public class GaPopupWindowAdapter extends BaseAdapter {
    private static final String TAG = GaPopupWindowAdapter.class.getSimpleName();

    private int currentItem = -1;
    private Context context;
    private List<GaBean> datalist;
    private OnTransferClickListener onTransferClickListener;

    public GaPopupWindowAdapter(Context context, List<GaBean> datalist) {
        this.context = context;
        this.datalist = datalist;
    }
    public GaPopupWindowAdapter(Context context) {
        this.context = context;
    }
    ...
    public void setData( List<GaBean> datalist,int lowerMemberUserId) {
        this.datalist = datalist;
...
//        notifyDataSetChanged();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GaBean gaBean = datalist.get(position);
        if (currentItem == gaBean.getLotteryId()) {
        ...
        holderView.textView.setText(gaBean.getCname() + "");
...
//            }
    ...
    public interface OnTransferClickListener {
        void onTransferListener(GaBean gaBean);
    }
}