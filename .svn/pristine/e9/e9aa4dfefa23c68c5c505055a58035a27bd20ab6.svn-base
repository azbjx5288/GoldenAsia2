 ...
 */
@RequestConfig(api = "?c=user&a=forgetPwd", response = FindPasswordResponse.class,request = ForgetPwdRequest.class)
public class ForgetPwdStep1Command {
    /**
     * 1(默认值)	验证资金密码是否正确
     * 2	重置新密码
     */
