...
public class RestRequestManager {
    ...
    public static RestRequest createRequest(Context context, Object command, TypeToken typeToken,
                                                 RestCallback callback, int id, Object tag) {
        RestRequest requestBase = create(context, command, callback, id);
        if (requestBase != null) {
    ...
    private static RestRequest create(Context context, Object command,
                                          RestCallback callback, int id) {
