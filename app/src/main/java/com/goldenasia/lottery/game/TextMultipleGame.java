...
public class TextMultipleGame extends Game {
    ...
    private static String[] oddEvenSumText = new String[]{"奇", "和", "偶"};
    ...
    public void onRandomCodes() {
        try {
            ...
            e.printStackTrace();
            Log.i("TextMultipleGame", "onInflate: " + "//" + method.getCname() + "随机 " + method.getName() + " public " + "static void " + method.getName() + "Random" + "" + "(Game " + "game) {}");
            Toast.makeText(topLayout.getContext(), "不支持的文字类型", Toast.LENGTH_LONG).show();
        }
    }
