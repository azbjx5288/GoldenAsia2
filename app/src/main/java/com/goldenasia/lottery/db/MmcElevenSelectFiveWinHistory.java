 ...
 */
@DatabaseTable()
public class MmcElevenSelectFiveWinHistory {
    ...
    public MmcElevenSelectFiveWinHistory() {
    }

    public MmcElevenSelectFiveWinHistory(int uid, String count, String number, String betMoney, String winMoney) {
        this.uid = uid;
        this.count = count;
        this.number = number;
        this.betMoney = betMoney;
