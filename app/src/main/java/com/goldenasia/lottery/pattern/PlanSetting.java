...
public class PlanSetting implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    public PlanSetting(Activity activity) {
        ...
        radioGroup = (RadioGroup) planSetView.findViewById(R.id.plan_radiogroup);

        ratiolayout0 = (LinearLayout) planSetView.findViewById(R.id.ratiolayout_0);
        ratiolayout1 = (LinearLayout) planSetView.findViewById(R.id.ratiolayout_1);
        ratiolayout2 = (LinearLayout) planSetView.findViewById(R.id.ratiolayout_2);
        ratiolayout3 = (LinearLayout) planSetView.findViewById(R.id.ratiolayout_3);

        radioButton0 = (RadioButton) planSetView.findViewById(R.id.plan_ratio_0);
        radioButton1 = (RadioButton) planSetView.findViewById(R.id.plan_ratio_1);
        radioButton2 = (RadioButton) planSetView.findViewById(R.id.plan_ratio_2);
        radioButton3 = (RadioButton) planSetView.findViewById(R.id.plan_ratio_3);

        EditText plan_way_0=(EditText)planSetView.findViewById(R.id.plan_way_0);
        plan_way_0.setOnFocusChangeListener(this);
        plan_way_0.addTextChangedListener(new LimitTextWatcher(plan_way_0,5));

        EditText plan_way_1_0=(EditText)planSetView.findViewById(R.id.plan_way_1_0);
        plan_way_1_0.setOnFocusChangeListener(this);
        plan_way_1_0.addTextChangedListener(new LimitTextWatcher(plan_way_1_0,3));

        EditText plan_way_1_1=(EditText)planSetView.findViewById(R.id.plan_way_1_1);
        plan_way_1_1.setOnFocusChangeListener(this);
        plan_way_1_1.addTextChangedListener(new LimitTextWatcher(plan_way_1_1,5));

        EditText plan_way_1_2=(EditText)planSetView.findViewById(R.id.plan_way_1_2);
        plan_way_1_2.setOnFocusChangeListener(this);
        plan_way_1_2.addTextChangedListener(new LimitTextWatcher(plan_way_1_2,5));

        EditText plan_way_2=(EditText)planSetView.findViewById(R.id.plan_way_2);
        plan_way_2.setOnFocusChangeListener(this);
        plan_way_2.addTextChangedListener(new LimitTextWatcher(plan_way_2,5));

        EditText plan_way_3_0=(EditText)planSetView.findViewById(R.id.plan_way_3_0);
        plan_way_3_0.setOnFocusChangeListener(this);
        plan_way_3_0.addTextChangedListener(new LimitTextWatcher(plan_way_3_0,3));

        EditText plan_way_3_1=(EditText)planSetView.findViewById(R.id.plan_way_3_1);
        plan_way_3_1.setOnFocusChangeListener(this);
        plan_way_3_1.addTextChangedListener(new LimitTextWatcher(plan_way_3_1,5));

        EditText plan_way_3_2=(EditText)planSetView.findViewById(R.id.plan_way_3_2);
