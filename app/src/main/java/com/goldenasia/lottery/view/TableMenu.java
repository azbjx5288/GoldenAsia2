...
public class TableMenu extends ViewGroup implements View.OnClickListener {
    ...
    private int commonBackground;
    //    private Paint divideLinePaint;
    private int[] divideLineY;
//    private int divideLineHigh;
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.shape_rec_button;
    ...
    private void init(AttributeSet attrs) {
        ...
        textSize = attribute.getDimensionPixelSize(R.styleable.TableMenu_tmTextSize, 8);
        ...
        currentBackground = attribute.getResourceId(R.styleable.TableMenu_tmCurrentBackground, DEFAULT_TEXT_BACKGROUND);
        commonBackground = attribute.getResourceId(R.styleable.TableMenu_tmCommonBackground, DEFAULT_TEXT_BACKGROUND);
    ...
    public void setCurrentMethod(Method currentMethod) {
        if (this.currentMethod != null) {
            ...
            if (textView != null) {
                ...
                textView.setBackgroundResource(commonBackground);
            }
        }
        ...
        if (textView != null) {
            ...
            textView.setBackgroundResource(currentBackground);
        }
    }
