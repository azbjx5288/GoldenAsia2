...
public class LhcNumberGroupView extends View {
    ...
    private boolean enabledLineClick= false;
    ...
    private OnChooseLineClickListener chooseLineListener;
    ...
    private void init(AttributeSet attrs, Context context) {
        ...
        isColorful = attribute.getBoolean(R.styleable.NumberGroupView_isColorful, true);
        ...
        enabledLineClick = attribute.getBoolean(R.styleable.NumberGroupView_enabledLineClick, false);
    ...
    /**
     * 选择模式 true 单选模式 false 多选模式 Null无法点击
     */
    ...
    private boolean isEnabledLineClick() {
        return enabledLineClick;
    }

    public void setEnabledLineClick(boolean enabledLineClick) {
        this.enabledLineClick = enabledLineClick;
    }
    ...
    public void setChooseLineListener(OnChooseLineClickListener chooseLineListener, int lineID) {
        this.chooseLineListener = chooseLineListener;
        this.lineId = lineID;
    }
    ...
    private void calculateClick(int eventX, int eventY) {
        ...
        for (int i = 0, count = maxNumber - minNumber + 1; i < count; i++) {
            ...
            if (rect.contains(eventX, eventY) && !enabledLineClick) {
                if (isRadioStyle()) {
                ...
                invalidate();
                return;
            } else if(enabledLineClick) {
                if (chooseLineListener != null) {
                    chooseLineListener.onChooseLineClick(getLineId());
                }
                invalidate();
                return;
            }
    ...
    public interface OnChooseLineClickListener {
        void onChooseLineClick(int lineID);
    }
}
