 ...
 */
public class BetOrTraceDetailMmcFragment extends BaseFragment
{
    private static final String TAG = BetOrTraceDetailMmcFragment.class.getSimpleName();
    ...
    public static void launch(BaseFragment fragment, Bet bet)
    {
        ...
        FragmentLauncher.launch(fragment.getActivity(), BetOrTraceDetailMmcFragment.class, bundle);
    }
    ...
    private class JsInterface
    {
        ...
        {
            BetOrTraceDetailMmcFragment.this.pkids = pkids;
            button.post(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    {
                        if (supportCancel && BetOrTraceDetailMmcFragment.this.pkids != null &&
                                BetOrTraceDetailMmcFragment.this.pkids.length > 0)
                        {
                            button.setText("撤单");
                        } else
                        {
    ...
    public void onClick(View v)
    {
        ...
        if (!supportCancel)
        {
            //GameMmcFragment.launch(this, lottery);
            return;
        }
