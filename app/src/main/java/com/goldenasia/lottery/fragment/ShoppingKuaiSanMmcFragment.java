...
import com.goldenasia.lottery.component.MmcKuaiSanOneArmBanditView;
...
public class ShoppingKuaiSanMmcFragment extends BaseFragment
{
    private static final String TAG = ShoppingKuaiSanMmcFragment.class.getSimpleName();
    ...
    private MmcKuaiSanOneArmBanditView mmcOneArmBanditView;
    ...
    {
        return inflateView(inflater, container, "投注", R.layout.shopping_kuaisan_mmc_fragment);
    }
    ...
    {
        mmcOneArmBanditView = new MmcKuaiSanOneArmBanditView(getActivity(), findViewById(R.id.one_arm_bandit));
    }
