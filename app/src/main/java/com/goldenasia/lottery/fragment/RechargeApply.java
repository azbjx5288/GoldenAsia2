...
public class RechargeApply extends BaseFragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        emptyView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, LinearLayout
                    ...
                    if (cardRecharge != null)
                    {
                        switch (cardRecharge.getBankId())
                        {
                            case 101:
                                ...
                                builder.setColorfulMsg(Html.fromHtml("1、平台不定期<font " +
                                        "color='#ee7e45'>会更换收款账号。</font>每次充值前，<font " +
                                        "color='#ee7e45'>请务必填写“充值金额”和“支付宝真实姓名”后，获取当前收款账号再进行打款。</font>\n" +
                                        "2、如因线下充值所导致的资金损失，平台不予以任何赔偿。"));
                                builder.create().show();
                                break;
                            case 203:
                                //callPhone();
    ...
    private void configLoad()
    {
        ...
        {};
        RestRequest restRequest = RestRequestManager.createRequest(getActivity(), configCommand, typeToken,
                restCallback, TRACE_RECHARGE_CONFIG_COMMAND, this);
        restRequest.execute();
    }
