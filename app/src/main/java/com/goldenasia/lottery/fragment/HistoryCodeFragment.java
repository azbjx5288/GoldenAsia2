...
import com.goldenasia.lottery.app.FragmentDelayer;
...
public class HistoryCodeFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener,ViewPager.OnPageChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflateView(inflater, container, "开奖", R.layout.fragment_history_code);
    }
    ...
    protected void init() {
        ...
        Fragment resultsFragment = FragmentDelayer.newInstance(R.drawable.ic_tab_classify, ResultsFragment.class.getName(), bundle);
        Fragment chartTrendFragment = FragmentDelayer.newInstance(R.drawable.ic_tab_discover, ChartTrendFragment.class.getName(), bundle);
