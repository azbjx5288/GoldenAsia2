...
public class UpdateAppActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        cancleBtn = findViewById(R.id.dialog_confirm_cancle);
        content = findViewById(R.id.dialog_confirm_title);
        lineIn = findViewById(R.id.line_in);
    ...
    private void download() {
        ...
        if (updateBean.getDownloadBy() == UpdateAppUtils.DOWNLOAD_BY_APP) {
            if (isNetWorkInfoConnected(this)) {
     ...
     * 检测wifi 与移动 网络是否连接
     */
    private boolean isNetWorkInfoConnected(Context context) {
